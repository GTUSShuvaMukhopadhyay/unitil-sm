...
# Save to CSV
output_df.to_csv('STAGE_STREETS11.csv', index=False, header=True, quoting=csv.QUOTE_NONE, escapechar='\\')

print("CSV file has been created and saved as 'STAGE_STREETS11.csv'.")
