...
file_path2 = r"BNG Gas Meter Attributes Cleanup 03_09_25 (1).xlsx"
...
df_new['BUILTCONFIG'] = df.apply(
    lambda row: str(501).zfill(4) if pd.notna(row.iloc[18]) and row.iloc[18] != ''
    else (str(591).zfill(4) if pd.notna(row.iloc[24]) and row.iloc[24] != '' else '592'),
    axis=1
)
...
df_new['OTHERDEVICETYPE1'] = ""
df_new['OTHERDEVICEID1'] = ""
df_new['OTHERDEVICEMARRY1'] = "Y"
df_new['OTHERDEVICETYPE2'] = ""
...
df_new['MAKESIZE'] = df_new['METERNUMBER'].apply(fetch_makesize)
...
df_new['FLEXFIELD1'] = df_new['MAKESIZE']
df_new['FLEXFIELD2'] = ""
df_new['FLEXFIELD3'] = "0"
...
# Save to CSV
output_path = r"STAGE_DEVICEQN.csv"
...
numeric_columns = [
    ...
    'OTHERDEVICETYPE1', 'OTHERDEVICETYPE2', 'METERMAKE', 'METERSIZE', 'METERKIND', 'METERMODEL',
